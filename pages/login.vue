  ...
  <div class="flex flex-col min-h-screen">
    ...
    <div class="relative w-full h-screen lg:max-w-5xl lg:mx-auto">
      ...
      <div class="absolute bottom-0 w-full p-4 md:p-8 rounded-t-3xl shadow-lg">
        <h1 class="text-4xl md:text-3xl text-center text-white font-sora font-semibold">
          Just make<br />
          an appointment<br />
          with e-service
        </h1>
        ...
        <div class="text-center mb-4 font-semibold text-base font-sora text-white">
          Connect with
        </div>
        <!-- Social icons -->
        <div class="flex justify-center space-x-7 mb-3">
          <button class="w-14 h-14 rounded-[12px] bg-white flex items-center justify-center" @click="signInWithOtp">
            <GoogleIcon />
          </button>
          <button class="w-14 h-14 rounded-[12px] bg-white flex items-center justify-center">
            <FacebookIcon />
          </button>

          <button class="w-14 h-14 bg-white rounded-[12px] flex items-center justify-center">
            <AppleIcon />
          </button>
        </div>
      </div>
